...
class ReservationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code_client' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'code_client' => ['type' => 'unique', 'columns' => ['code_client'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
